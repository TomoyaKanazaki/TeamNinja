...
#define KEY_UP_ROT_Y		(DIK_I)	// Y軸拡大キー
#define NAME_UP_ROT_Y		("I")	// Y軸拡大表示
#define KEY_DOWN_ROT_Y		(DIK_K)	// Y軸縮小キー
#define NAME_DOWN_ROT_Y		("K")	// Y軸縮小表示
#define KEY_UP_ROT_Z		(DIK_O)	// Z軸拡大キー
#define NAME_UP_ROT_Z		("O")	// Z軸拡大表示
#define KEY_DOWN_ROT_Z		(DIK_L)	// Z軸縮小キー
#define NAME_DOWN_ROT_Z		("L")	// Z軸縮小表示
...
void CEditCollPolygon::DrawDebugControl(void)
{
	...
	DebugProc::Print(DebugProc::POINT_RIGHT, "Y軸回転：[%s/%s+%s]\n", NAME_UP_ROT_Y, NAME_DOWN_ROT_Y, NAME_TRIGGER);
