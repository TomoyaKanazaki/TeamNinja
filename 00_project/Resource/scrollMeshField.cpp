...
//	コンストラクタ
//============================================================
CScrollMeshField::CScrollMeshField(const CObject::ELabel label, const EScene scene, const EDim dimension, const int nPriority) : CObjectMeshField(label, scene, dimension, nPriority),
